...
```{r}
t1 <- rpartXse( rate_interval ~  sex + age + country_development + generation + year + Continent , se = 0.5, train_set, cp = 0.005,  maxdepth = 20  
                , model = TRUE)
...
forest <- randomForest(rate_interval ~  sex + age + country_development  + generation +  Continent , train_set, ntree = 200, mtry = 2) # mtry feature subsets
